...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4"> 
          <form method="post" action="?controlador=Producto&accion=guardarGarantia">
              <hr style="color: #47748b">
            <strong> <center> Registrar Garantias  </center> </strong>     <hr style="color: #47748b">
            ...
            <div class="form-group ">
                ...
                <input class="form-control" id="productocantidadgarantias" placeholder="Cantidad de Garantias Aplicadas" name="productocantidadgarantias" type="number" required="">
