...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4"> 
            ...
            <strong> <center> Modificar  Devolución  </center> </strong>     <hr style="color: #47748b">
            ...
            <div class="form-group ">
                ...
                <button class="btn btn-primary" type="submit" value="Registrar">Modificar Devolución</button>
