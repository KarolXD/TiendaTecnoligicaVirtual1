                    ...
                    foreach ($vars['listado'] as $item) {
                        ...
                        <div class="form-group">
                            ...
                            for ($i = 0; $i <= $contadorComas - 1; $i++) {
                                ?>
                                <label>Correos</label>
                                <input type="email"  pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}"  class="form-control"   value= "<?php echo $pieces[$i] ?>" name="correo[]" aria-describedby="emailHelp" placeholder="Correos" >     <?php
                            }
                            ?>
