...
tbclicksofertacategoria int,
tbclicksofertasubcategoria int,
tbclicksofertavalor int,
tbclicksofertacriterio int,
tbclicksofertaregular int,
tbclicksofertanormalm int ,
tbclicksfertafecha datetime
);
